...
const styles = {
  ...
  panelButton: "text-center duration-150 ease-in py-2 px-2 sm:py-3 sm:px-8 rounded-lg hover:bg-[#5651e5] hover:text-white bg-white text-gray-700 font-bold text-lg cursor-pointer",
